    ...
    **Example**
    ...
    def load_data(self, mode='train'):
        ...
        for class_idx, class_name in enumerate(classes):
            self.idx_to_class[class_idx]=class_name.split('.')[1].replace('_', ' ')
...
class TieredImagenet(data.Dataset):
    ...
    **Example**
    ...
    def __init__(self, root, mode='train', transform=None, target_transform=None, download=False):
        ...
        self.labels = labels['label_specific']
        self.class_names = labels['label_specific_str']
        self.class_to_idx = index_classes(self.class_names)

        self.idx_to_class = {}
        for class_idx, class_name in enumerate(self.class_names):
            self.idx_to_class[class_idx]=class_name.split(',')[0]
